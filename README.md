...
Performance measured via [`benchmark_encoder.py`](nai_t5_wrapper/scripts/benchmark_encoder.py), using environment:
...
Precision compared via [`t5_encoder_hf_precision_parity.py`](nai_t5_wrapper/scripts/t5_encoder_hf_precision_parity.py), using environment:
