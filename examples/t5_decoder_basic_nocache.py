...
from nai_t5_wrapper.sampling import BoundDecode, MakeLogitGenerator, generate_greedy, generate_until
...
bound_decode: BoundDecode = partial(decode, encoding=emb, cross_mask=cross_mask)
