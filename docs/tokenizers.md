...
We offer a script [`tokenizer_hf_to_sentencepiece.py`](../nai_t5_wrapper/scripts/tokenizer_hf_to_sentencepiece.py) which outputs a new `spiece.model` with the new special tokens included.
